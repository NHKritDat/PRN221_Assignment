...
{
    public class LoginXmlModel : PageModel
    {
        private ICustomerService _customerService;
        public LoginXmlModel(ICustomerService customerService)
        {
        ...
        public void OnPost()
        {
            ...
            List<Customer> customers = ToListModel(_customerService.GetCustomers("D:\\Develops\\Projects\\Personal\\PRN221_Assignment\\NguyenHoangDat_SE170330\\Hotel_Daos\\customer", ".xml"));
            customers.ForEach(c =>
            {
                if (c.EmailAddress.Equals(email) && c.Password.Equals(password))
                {
                    ...
                    Response.Redirect("/ProfileXml/Profile?id=" + c.CustomerId);
                }
            });
        }
